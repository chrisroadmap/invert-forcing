...
# %%
F_init = canesm5_model_net_anomaly + kappa1 * canesm5_model_tas_anomaly
...
# %%
pl.plot(ebm3.toa_imbalance - canesm5_model_net_anomaly)

# %%
pl.plot(ebm3.temperature[:, 0] - canesm5_model_tas_anomaly)

# %%
cost_function(ebm3.toa_imbalance, ebm3.temperature[:,0], canesm5_model_net_anomaly, canesm5_model_tas_anomaly)
...
def ebm_processor(forcing):
    ...
    return cost_function(ebm3.toa_imbalance, ebm3.temperature[:,0], canesm5_model_net_anomaly, canesm5_model_tas_anomaly)
